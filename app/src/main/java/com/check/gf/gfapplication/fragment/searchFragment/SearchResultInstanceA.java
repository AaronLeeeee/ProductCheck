//package com.check.gf.gfapplication.fragment.searchFragment;
//
//
...
//    private final com.chad.library.adapter.base.listener.SimpleClickListener SimpleClickListener = new SimpleClickListener() {
//        @Override
