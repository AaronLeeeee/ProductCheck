...
public interface CheckApi {
    ...
    Observable<CheckOrder> CheckOrderQuery(@Query("customerName") String customerName, @Query("requireDate") String requireDate, @Query("equipmentNo") String equipmentNo, @Query("docNo") String docNo, @Query("materialCode") String materialCode, @Query("custNo") String custNo);
    ...
    Observable<CheckOrderInfo> CheckOrderInfoQuery(@Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode);
...
//    Observable<InspectType> InspectTypeQuery();
    ...
    Observable<InspectItem> InspectItemListQuery(@Query("inspectCode") String inspectCode, @Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode);
    ...
    Observable<StartCheckResult> StartCheck(@Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode);
    ...
    Observable<ResultObject> SaveCheckResult(@Query("inspectCode") String inspectCode, @Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode, @Query("itemCode") String itemCode, @Query("checkResult") int checkResult, @Query("userName") String userName, @Query("postCode") String postCode, @Query("groupCode") String groupCode);
    ...
    Observable<ResultObject> SaveItemChkCnt(@Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode, @Query("inspectCode") String inspectCode, @Query("itemCode") String itemCode, @Query("checkContent1") String checkContent1, @Query("checkContent2") String checkContent2, @Query("checkContent3") String checkContent3, @Query("checkContent4") String checkContent4, @Query("checkContent5") String checkContent5);
    ...
    Observable<ImageUploadResult> ItemChkUploadImg(@Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode, @Query("inspectCode") String inspectCode, @Query("itemCode") String itemCode, @Part MultipartBody.Part file);
...
//    Observable<ItemPic> ItemPicListQuery(@Query("inspectCode") String inspectCode, @Query("equipmentNo") String equipmentNo, @Query("itemCode") String itemCode);
    ...
    Observable<InspectItemDetail> ItemDetailQuery(@Query("inspectCode") String inspectCode, @Query("equipmentNo") String equipmentNo, @Query("materialCode") String materialCode, @Query("itemCode") String itemCode);
